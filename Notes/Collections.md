...
| Key Type              | Heterogeneous elements allowed because it does not perform sorting on keys. | Heterogeneous elements allowed                                                          | Homogeneous elements only                                                         | Heterogeneous elements allowed                                              |
